...
namespace SET09102_Coursework.ViewModels
{
    ...
    public partial class AdminBackUpViewModel : ObservableObject
    {
        ...
        public readonly string[] tableNames = new[] { "Users", "Roles", "Sensors", "SensorTypes", "AirQData", "WaterQData", "WeatherData" };
        ...
        * Also creates a sort of version-control system for backups so long as users regularly create backups.*/
        private string _name = "Admin_DB_Backup";
        public string Name
        {
            get => _name;
        ...
        private System.DateTime currentDate = DateTime.Now.Date;
        public string CurrentDate
        {
            get => currentDate.ToString("yyyy-MM-dd");
            set => SetProperty(ref currentDate, DateTime.Parse(value));
        }
        ...
        */
        ...
        public void nextPage()
        {
            ...
            else
            {
                ...
                Shell.Current.DisplayAlert("You have reached the last table.",
                    $"The current table index is {currentTable}. Please try navigating back through the data for the table you desire.", "OK");
            }
        }
        ...
        */
        ...
        public void previousPage()
        {
            ...
            {
                /*! \brief An error message for if the table index would go out of bounds.*/
                Shell.Current.DisplayAlert("You have reached the first table.",
                    $"The current table index is {currentTable}. Please try navigating forward through the data for the table you desire.", "OK");
            }
        }
        ...
        */
        ...
        public bool CopyDatabase()
        {
            try
            {
                ...
                string projectPath = AppContext.BaseDirectory.Split(@"bin\", StringSplitOptions.None)[0];
                ...
                Shell.Current.DisplayAlert("Success", $"Data exported to backup database '{databaseName}' successfully.", "OK");
                return true;
            }
            catch (Exception ex)
            {
                ...
                Shell.Current.DisplayAlert("Error", "Failed to export data. Please try again later.", "OK");
            }
            return false;
        }
        ...
        */
        ...
        {
            var tableDataLoaders = new Dictionary<int, Func<IEnumerable<object>>>
            {
                { 0, () => _context.Users.ToList() },
                { 1, () => _context.Roles.ToList() },
                { 2, () => _context.Sensors.ToList() },
                { 3, () => _context.SensorTypes.ToList() },
                { 4, () => _context.AirQData.ToList() },
            ...
            else
            {
                ...
                Shell.Current.DisplayAlert("Error! Out of bounds table value.",
                    $"The current table index is {currentTable}, which is invalid. If this issue persists, please contact our customer support team.", "OK");
                currentTable = 0;
            }
        }
    }
