...
namespace SET09102_Coursework.Test
{
    public class OpsAnomalyManagerTestsSuite1 : IClassFixture<DatabaseFixture>
    {
        ...
        * Note: This test relies on the LoadData function to verify the behavior of previousPage, 
        * which introduces a dependency and makes it not a pure unit test.
        * Therefore, this test is not a pure unit test but rather an integration test.
        */
        [Fact]
